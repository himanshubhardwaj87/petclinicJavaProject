...
1.	Download maven
2.	Configure its path
3.	Check maven version. Maven -version
4.	Copy jmx file in path /src/test/jmeter
5.	Add pom.xml file in root folder
6.	Update the pom.xml file per script
